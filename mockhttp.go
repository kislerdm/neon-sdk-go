...
var endpointResponseExamples = map[string]map[string]mockResponse{ 
        ...
        "/organizations/{org_id}": { 
            "GET": mockResponse{
                    Content: `{"created_at":"2024-02-23T17:42:25Z","handle":"my-organization-my-organization-morning-bread-81040908","id":"my-organization-morning-bread-81040908","managed_by":"console","name":"my-organization","plan":"scale","require_mfa":false,"updated_at":"2024-02-26T20:41:25Z"}`,
                    Code: 200,
                },
        },
